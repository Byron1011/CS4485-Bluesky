...
app.get("/api/ner", async (req, res) => {
  const raw_posts = [
    { username: "sso1", text: "I need help in an undisclosed location" },
    { username: "sso2", text: "There is an earthquake in Tokyo, Japan" },
    { username: "sso3", text: "There is a wildfire heading towards Richardson, Texas" }
  ];
